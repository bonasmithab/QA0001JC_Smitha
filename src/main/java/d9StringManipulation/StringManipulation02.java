...
//        String str = "Learn java earn 3456 money";
        ...
        System.out.println("strWithSpace = " + strWithSpace);
         ...
         16) Only Word Characters ====> \\w  //Removing Characters
         17) except Word Characters ====> \\W // STAYING Characters
         18) Beginning of input sequence ====> \\A Replaces very beginning of input string
         19) End of the input sequence ========> \\Z Places at the end of the input string
